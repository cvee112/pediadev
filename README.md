...
Simply open the website in any web browser. No internet connection is required after the initial load (Tailwind CSS is cached).

## Feedback

This is a work-in-progress. For feedback, feel free to message me via Telegram (@cvee112).
